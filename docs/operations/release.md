...
2. Create an explicit App ID for `com.t3tools.t3code.experimental.pi` and enable Associated Domains.
...
- macOS build unsigned when expected signed:
  ...
  - Confirm the provisioning profile belongs to `APPLE_TEAM_ID.com.t3tools.t3code.experimental.pi` and includes
    Associated Domains.
